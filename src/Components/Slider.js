    ...
    render() {
        ...
        return (
                <Slider className="slider_container" {...settings}>
                    <div>
                        <a href="http://dmka.allan690.usermd.net" target='blank'><img alt='Shopper website - a CodersLab final project' src={page1}/></a>
                    </div>
                    <div>
                    ...
                    <div>
                        <a href="https://github.com/Aleksandra-Kulesz/shopper" target='blank'><img alt='Shopper website - a CodersLab final project' src={page4}/></a>
                    </div>
                </Slider>
        );
    }
